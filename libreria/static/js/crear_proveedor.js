$(document).ready(function() {
    $('#crear-proveedor-form').on('submit', function(event) {
        ...
        // Validaciones...
        const nitRegex = /^\d{9,11}-\d{1}$/; // Permite de 10 a 12 dígitos, un guion y un dígito
        ...
        setTimeout(function() {
            ...
            setTimeout(() => {
                ...
                $('#crear-proveedor-form')[0].submit(); // Envía el formulario
