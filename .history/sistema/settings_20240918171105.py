...
EMAIL_HOST_USER = 'mateochaparroburgos189@gmail.com'  # Tu usuario de Gmail
EMAIL_HOST_PASSWORD = 'tu_contraseña_o_contraseña_de_aplicación'  # Tu contraseña
EMAIL_PORT = 587  # Cambiado a entero
EMAIL_USE_TLS = True
