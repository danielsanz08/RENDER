...
urlpatterns = [
    ...
    path('editar_insumo/<int:insumo_id>/', viewseditar_insumo, name='editar_insumo'),
    ...
    path('productos/editar/<int:pk>/', views.editar_producto, name='editar_producto'),  # Editar un producto
