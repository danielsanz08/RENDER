...
class Transaccion(models.Model):
    ...
    producto = models.ForeignKey(Producto, on_delete=models.CASCADE, default=1)  # Asegúrate de que el ID 1 es válido
     descripcion = models.CharField(max_length=255, null=False, default="Descripción por defecto")
