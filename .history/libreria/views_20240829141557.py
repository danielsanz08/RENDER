...
@breadcrumb('Crear Perfil', 'crear_perfil')
...
@breadcrumb('Crear Transacción', 'crear_transacciones')
@login_required
...
@breadcrumb('Ver Transacciones', 'ver_transacciones')
@login_required
...
@breadcrumb('Listar Usuarios', 'listar_usuario')
@login_required
def listar_usuario(request):
    usuarios = CustomUser.objects.all()
    return render(request, 'usuario/listar.html', {'usuarios': usuarios})

@breadcrumb('Agregar Insumo', 'agregar_insumo')
@login_required
...
@breadcrumb('Editar Insumo', 'editar_insumo')
@login_required
...
@breadcrumb('Consultar Insumo', 'consultar_insumo')
@login_required
...
@breadcrumb('Backup y Restauración', 'backup_view')
@login_required
