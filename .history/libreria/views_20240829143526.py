...
def inicio(request):
    ...
    return render(request, 'indexindex.html', {'breadcrumbs': breadcrumbs})
...
def usuario(request):
    ...
    return render(request, 'usuario.html', {'breadcrumbs': breadcrumbs})
def contabilidad(request):
    breadcrumbs = [
        {'name': 'Inicio', 'url': '/'},
        {'name': 'Contabilidad', 'url': None},
    ]
    return render(request, 'contabilidad.html', {'breadcrumbs': breadcrumbs})
