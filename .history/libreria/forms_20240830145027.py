...
class CustomPasswordChangeForm(forms.Form):
    ...
    def clean_old_password(self):
        old_password = self.cleaned_data.get('Actual contraseña')
    ...
    def clean(self):
        cleaned_data = super().clean()
        new_password1 = cleaned_data.get('Contraseña1')
        new_password2 = cleaned_data.get('Contraseña2')
        if new_password1 != new_password2:
            raise forms.ValidationError("Las nuevas contraseñas no coinciden.")
        return cleaned_data

    def save(self):
        new_password = self.cleaned_data.get('Contraseña1')
