...
function mostrarAlerta() {
    ...
    document.querySelector('.overlay').style.display = 'block'; // Mostrar la superposición de fondo
}

function cerrarVentana() {
    document.getElementById("alert").style.display = 'none';
    document.querySelector('.overlay').style.display = 'none'; // Ocultar la superposición de fondo
}
