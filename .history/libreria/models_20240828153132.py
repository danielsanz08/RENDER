...
class Backup(models.Model):
    file_name = models.CharField(max_length=255)  # Nombre del archivo de respaldo
    created_at = models.DateTimeField(auto_now_add=True)  # Fecha de creación automática
    file_path = models.CharField(max_length=1024)  # Ruta del archivo en el sistema
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True)  # Usuario que creó el backup
