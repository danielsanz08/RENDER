...
class ProveedorForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Agregar el placeholder para el campo tipo_persona
        self.fields['tipo_persona'].widget.attrs.update({'class': 'form-control', 'placeholder': 'Seleccione una opción'})

        # Añadir un valor inicial vacío como opción para tipo_persona
        self.fields['tipo_persona'].empty_label = 'Seleccione una opción'
