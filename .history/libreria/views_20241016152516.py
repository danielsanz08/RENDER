...
def editar_insumo(request, insumo_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('nombre_de_la_vista_donde_redirigir')  # Cambia esto por tu URL de redirección
    else:
        form = InsumoForm(instance=insumo)
    
    return render(request, 'tu_template/editar_insumo.html', {'form': form})
@login_required
