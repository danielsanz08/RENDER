...
def usuario(request):
    ...
    return render(request, 'usuario/usuario.html', {'breadcrumbs': breadcrumbs})
...
def ver_perfil(request):
    ...
    return render(request, 'usuario/ver.html', {'breadcrumbs': breadcrumbs})
...
def cambiar_contraseña(request):
    ...
    return render(request, 'usuario/nueva_contraseña.html', {'breadcrumbs': breadcrumbs})
...
def consultar_insumo(request):
    ...
    breadcrumbs = [
        {'name': 'Inicio', 'url': '/'},
        {'name': 'Insumos', 'url': None},  # Puedes cambiar esta URL a la que consideres correcta si hay una página principal de Insumos
    ]
