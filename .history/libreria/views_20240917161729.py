...
def ver_perfil(request):
    ...
    breadcrumbs = [{'name': 'Inicio', 'url': '/inicio/'}, {'name': 'Usuario', 'url': '/usuario/'}, {'name': 'Ver Perfil', 'url': '/ver_perfil'}]
...
def inactivar_usuario(request, id):
    ...
    usuario.save()
    messages.success(request, f'Usuario {usuario.username} inactivado.')
    return redirect('listar_usuario')
@csrf_exempt
