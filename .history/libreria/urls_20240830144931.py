...
urlpatterns = [
    ...
    path('change_password/', views.cambiar_contraseña, name='cambiar_contraseña'),
    path('change_password/done/', TemplateView.as_view(template_name='password_change_done.html'), name='password_change_done'),
