...
def crear_transacciones(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            nueva_transaccion.cliente = form.cleaned_data['cliente']  # Ensure this is a valid Cliente instance
            nueva_transaccion.producto = form.cleaned_data['producto']  # Ensure this is a valid Producto instance or ID
