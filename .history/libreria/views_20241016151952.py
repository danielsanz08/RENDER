...
def editar_insumo(request, pk):
    ...
    if request.method == 'POST':
        form = InsumoForm(request.POST, instance=insumo)  # Asegúrate de que el formulario incluya todos los campos
        if form.is_valid():
            # Solo actualiza el insumo si todos los campos son válidos
