...
class BackupForm(forms.ModelForm):
    class Meta:
        model = Backup
        fields = ['file_name', 'file_path', 'created_at', 'created_by']  # Cambiar 'reated_at' por 'created_at'
        widgets = {
...
class ClienteForm(forms.ModelForm):
    class Meta:
        model = Cliente  # Reemplaza esto con tu modelo real
        fields = ['tipo_cliente', 'nombre', 'email', 'telefono', 'direccion']  # Campos que necesitas
...
class ProveedorForm(forms.ModelForm):
    class Meta:
        model = Proveedor
        fields = ['nit', 'nombre', 'direccion', 'email', 'telefono']
